...
namespace dgl {
    ...
    namespace internal_format {
        ...
        _internal_format rgba8_unorm = rgba8;
        _internal_format rgba16_unorm = rgba16;

        _internal_format rgb32f(GL_RGB32F, GL_RGB, GL_FLOAT);
        _internal_format rgb16f(GL_RGB16F, GL_RGB, GL_HALF_FLOAT);
        _internal_format rgb8(GL_RGB8, GL_RGB, GL_UNSIGNED_BYTE);
        ...
        _internal_format rgb16(GL_RGB16, GL_RGB, GL_UNSIGNED_SHORT);
        ...
        _internal_format rgb8_unorm = rgb8;
        _internal_format rgb16_unorm = rgb16;

        _internal_format rg32f(GL_RG32F, GL_RG, GL_FLOAT);
        _internal_format rg16f(GL_RG16F, GL_RG, GL_HALF_FLOAT);
        _internal_format rg8(GL_RG8, GL_RG, GL_UNSIGNED_BYTE);
        ...
        _internal_format rg16(GL_RG16, GL_RG, GL_UNSIGNED_SHORT);
        ...
        _internal_format rg8_unorm = rg8;
        _internal_format rg16_unorm = rg16;

        _internal_format r32f(GL_R32F, GL_RED, GL_FLOAT);
        _internal_format r16f(GL_R16F, GL_RED, GL_HALF_FLOAT);
        _internal_format r8(GL_R8, GL_RED, GL_UNSIGNED_BYTE);
        ...
        _internal_format r16(GL_R16, GL_RED, GL_UNSIGNED_SHORT);
        ...
        _internal_format r8_unorm = r8;
        _internal_format r16_unorm = r16;
